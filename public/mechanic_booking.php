            ...
            <div class="row">
                <div class="col-md-12" style="margin-top:20px">
                    ...
                    <div class="card text-black  mb-3">
                        <div class="card-header bg-success text-center text-white">Enter Mechanic Request Details</div>
                        <div class="card-body">
                            <form method="post">
                              ...
                              <input class="form-control" name="idcarowner" value =<?php echo $_SESSION['idcarowner'] ?> type="text" aria-describedby="nameHelp" placeholder="Enter Sparepart name" readonly hidden>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input class="form-control" name="carmodel" type="text" aria-describedby="nameHelp" placeholder="Enter the car model">
                                </div>
                                    <div class="form-group">
                                      <input type="submit" class="form-control btn btn-success" name="request_mechanic" value="SEND REQUEST">
                                    </div>
                                     <?php  request_mechanic(); ?>
                            </form>
                        </div>
                        <div class="">
                        </div>
