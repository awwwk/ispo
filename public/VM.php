        ...
        <div class="content-wrapper">
            <div class="container">
                ...
                <div class="row" style="margin-top:40px; margin-bottom:140px; ">
                    <div class="col-md-12">
                        ...
                        <div class="card text-black  mb-3">
                            <div class="card-header bg-primary text-center text-white"> MECHANIC SERVICES ORDER </div>
                            <div class="card-body">
                ...
                $query = query("SELECT * FROM mechanicrequest INNER JOIN CLIENT ON CLIENT.idcarowner=mechanicrequest.idcarowner join MECHANIC
                  where MECHANIC.specialization= mechanicrequest.carmodel
                   ...
                   // $formattedDate = date('F d, Y', $timestamp);                   
                    ...
                    echo "
                      <tr>
                                            ...
                                            <td>{$carmodel}</td>
                                            <td>{$idcarowner}</td>   
                                           <td>  <a class=' badge badge-success' style='padding:10px; border-radius:20px; margin-top:0px; margin-left:10px;  height:30px; width:200px; text-color:#00000 text-size:10px;'  href='MQ.php'>WRITE QUOTATION</a>  </td>
                                        </tr>
                                       </tr>
                    "; }                                      
                                        ?>
