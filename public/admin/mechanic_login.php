      ...
      <div class="card-body">
        ...
        <form  method="post" action="">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
               <input class="btn btn-primary btn-block" type="submit" name="mechanic_login" value="Login" >
          </div>
          <?php 
         ...
         <div class="text-center">
          <a class="d-block small mt-3" href="../admin/mechanic_register.php">Register an Account</a>
