    ...
    <body class="bg-dark">
        <div class="container">
            ...
            <div class="card card-register mx-auto mt-5">
                <div class="card-header">CAR CLINIC REGISTRATION</div>
                    ...
                    <form method="post">
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" name="userName" type="text" aria-describedby="nameHelp" placeholder="Enter Username">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" name="PhoneNo" type="text" aria-describedby="mobileNo" placeholder="Enter Mobile No">
                            </div>
